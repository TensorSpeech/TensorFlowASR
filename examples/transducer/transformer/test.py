...
def main(
    ...
    transformer.make(speech_featurizer.shape, batch_size=batch_size)
    ...
    exec_helpers.run_testing(model=transformer, test_dataset=test_dataset, test_data_loader=test_data_loader, output=output)
