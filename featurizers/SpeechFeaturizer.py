...
def speech_feature_extraction(signal: np.ndarray, speech_conf):
...
def compute_pitch_feature(signal: np.ndarray, speech_conf):
    frame_ms = speech_conf["frame_ms"]
    stride_ms = speech_conf["stride_ms"]
    sample_rate = speech_conf["sample_rate"]
...
def compute_spectrogram_feature(signal: np.ndarray, speech_conf):
    frame_ms = speech_conf["frame_ms"]
    stride_ms = speech_conf["stride_ms"]
    num_feature_bins = speech_conf["num_feature_bins"]
    sample_rate = speech_conf["sample_rate"]
...
def compute_mfcc_feature(signal: np.ndarray, speech_conf):
    frame_ms = speech_conf["frame_ms"]
    stride_ms = speech_conf["stride_ms"]
    num_feature_bins = speech_conf["num_feature_bins"]
    sample_rate = speech_conf["sample_rate"]
...
def compute_logfbank_feature(signal: np.ndarray, speech_conf):
    frame_ms = speech_conf["frame_ms"]
    stride_ms = speech_conf["stride_ms"]
    num_feature_bins = speech_conf["num_feature_bins"]
    sample_rate = speech_conf["sample_rate"]
